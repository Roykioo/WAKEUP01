...
namespace QInventory
{
    public class PlayerInventoryManager : MonoBehaviour
    {
        ...
        {
            foreach (PlayerAttribute m_Attribute in Q_GameMaster.Instance.inventoryManager.playerInventoryManager.playerAttributes)
            {
        ...
        public static void ChangePlayerAttributeByName(string attributeName, float changeAmount, Effect effect)
        {
            foreach (PlayerAttribute m_Attribute in Q_GameMaster.Instance.inventoryManager.playerInventoryManager.playerAttributes)
            {
                if (m_Attribute.playerAttribute.attributeName == attributeName)
                {
                    ...
                    m_Attribute.currentValue = Mathf.Clamp(m_Attribute.currentValue, m_Attribute.minValue, m_Attribute.maxValue);
                }
            }
        }
