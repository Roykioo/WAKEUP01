...
public class Q_InventoryMainEditorWindow : Q_InventoryEmptyEditorWindow
{
    ...
    void DrawBluePrint()
    {
        ...
        if (inventoryItemList.bluePrints.Count > 0)
        {
            ...
            {
                if(inventoryItemList.categories[categoryChooseIndex - 1] != inventoryItemList.bluePrints[bluePrintViewIndex - 1].category)
                {
                    for (int i = 0; i < inventoryItemList.bluePrints.Count; i++)
                    {
                        if (inventoryItemList.bluePrints[i].category == inventoryItemList.categories[categoryChooseIndex - 1])
                        {
            ...
            if (GUILayout.Button("Prev", GUILayout.ExpandWidth(false)))
            {
                ...
                if(inventoryItemList.categories.Count > 0 && categoryChooseIndex >= 1)
                {
                    for (int i = 0; i < inventoryItemList.bluePrints.Count; i++)
                    {
                        ...
                        if (inventoryItemList.bluePrints[bluePrintViewIndex - 1].category == inventoryItemList.categories[categoryChooseIndex - 1])
                            break;
                    }
                }
            ...
            if (inventoryItemList.bluePrints.Count > 0)
            {
                ...
                GUILayout.Space(5);
                inventoryItemList.bluePrints[bluePrintViewIndex - 1].category = EditorGUILayout.ObjectField("Category", inventoryItemList.bluePrints[bluePrintViewIndex - 1].category, typeof(Category), false) as Category;
                GUILayout.Space(5);
                //icon
    ...
    void DrawCategory()
    {
        ...
        if (inventoryItemList.categories.Count > 0)
        {
            ...
            if (inventoryItemList.categories.Count > 0)
            {
                ...
                categoryViewIndex = Mathf.Clamp(EditorGUILayout.IntField("Current Category", categoryViewIndex, GUILayout.ExpandWidth(false)), 1, inventoryItemList.categories.Count);
                EditorGUILayout.LabelField("of   " + inventoryItemList.categories.Count.ToString() + "  Category", "", GUILayout.ExpandWidth(false));
                ...
                //name
                EditorGUI.BeginChangeCheck();
                inventoryItemList.categories[categoryViewIndex - 1].categoryName = EditorGUILayout.DelayedTextField("Category Name", inventoryItemList.categories[categoryViewIndex - 1].categoryName as string);
                if (EditorGUI.EndChangeCheck())
                {
                    AssetDatabase.RenameAsset(EditorPrefs.GetString("DatabasePath") + "/BluePrints/Categories/" + inventoryItemList.categories[categoryViewIndex - 1].name + ".asset", inventoryItemList.categories[categoryViewIndex - 1].categoryName);
                    AssetDatabase.SaveAssets();
                }
            }
        }
    ...
    void DeleteCategory(int index)
    {
        if (inventoryItemList.categories.Count > 0)
        {
            ...
            System.IO.File.Delete(EditorPrefs.GetString("DatabasePath") + "/BluePrints/Categories/" + objName + ".asset");
            System.IO.File.Delete(EditorPrefs.GetString("DatabasePath") + "/BluePrints/Categories/" + objName + ".asset.meta");
